...
namespace SEMP.View
{// luis - 2011-11-17
    public class RelativeActiveOfUserComboBox : NamedEntityComboBox
    {
        private static NamedEntityHelper Helper = new NamedEntityHelper();
        static RelativeActiveOfUserComboBox() { ORM.Current.RelativeGetActiveOfUserAllCompleted += Helper.WCF_SetDefault; }
        private static void This_Loaded(Object Sender, EventArgs Args) { RelativeActiveOfUser.Load(); }
        public RelativeActiveOfUserComboBox()
        {
            Load(Helper.Source);
            ORM.Current.RelativeGetActiveOfUserAllCompleted += WCF_GetAll;
