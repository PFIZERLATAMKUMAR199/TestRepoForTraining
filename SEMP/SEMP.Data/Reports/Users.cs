...
{//luis - 2012-06-14
    ...
    public class Users
    {
        const string sCOL_USER_ID = "A";
        const string sCOL_USER_LOGIN = "B";
        const string sCOL_USER_NAME = "C";
        const string sCOL_USER_SURNAME = "D";
        const string sCOL_USER_EMAIL = "E";
        const string sCOL_USER_DELETE_DATE = "F";
        const string sCOL_REQUESTS_FOR_OTHERS = "G";
        const string sCOL_USER_EMPL_ID = "H";
        private string sCOL_FINAL = "H";

        const int nROW_TITLE = 4;

        public DateTime? dtBegin { get; set; }
        public DateTime? dtEnd { get; set; }
        public bool blnDetail { get; set; }
        ...
        public string Report()
        {
            using (var db = new BridgeDataContext())
            {
                ...
                string sFile = DateTime.Now.ToString("yyMMddHHmmss") + DateTime.Now.Millisecond + "_Users.xlsx";
        ...
        private void CreatePackage(String filePath, List<UsersResult> List)
        {
        ...
        public void CreateParts(SpreadsheetDocument excel, List<UsersResult> MyList)
        {
        ...
        {
            columns1.Append(new Column() { Min = 1, Max = 1, Width = 12D, CustomWidth = true }); //nUserID
            columns1.Append(new Column() { Min = 2, Max = 2, Width = 23D, CustomWidth = true }); //sUserLogin
            columns1.Append(new Column() { Min = 3, Max = 3, Width = 34D, CustomWidth = true }); //sUserName
            columns1.Append(new Column() { Min = 4, Max = 4, Width = 35D, CustomWidth = true }); //sUserSurname
            columns1.Append(new Column() { Min = 5, Max = 5, Width = 44D, CustomWidth = true }); //sUserEMail
            columns1.Append(new Column() { Min = 6, Max = 6, Width = 24D, CustomWidth = true }); //dtUserBornDate
            columns1.Append(new Column() { Min = 7, Max = 7, Width = 14D, CustomWidth = true }); //dtUserCreationDate
            columns1.Append(new Column() { Min = 8, Max = 8, Width = 22D, CustomWidth = true }); //sUserProfileName
            columns1.Append(new Column() { Min = 9, Max = 9, Width = 14D, CustomWidth = true }); //dtUserDeleteDate
            columns1.Append(new Column() { Min = 10, Max = 10, Width = 12D, CustomWidth = true }); //sUserFile
            columns1.Append(new Column() { Min = 11, Max = 11, Width = 30D, CustomWidth = true }); //nUserMaxProductsPerMonth
            columns1.Append(new Column() { Min = 12, Max = 12, Width = 32D, CustomWidth = true }); //sManagement
            columns1.Append(new Column() { Min = 13, Max = 13, Width = 29D, CustomWidth = true }); //nRequestsForOtherUsers
            columns1.Append(new Column() { Min = 14, Max = 14, Width = 15D, CustomWidth = true }); //sUserPhone
            columns1.Append(new Column() { Min = 15, Max = 15, Width = 14D, CustomWidth = true }); //sLocation
            columns1.Append(new Column() { Min = 16, Max = 16, Width = 33D, CustomWidth = true }); //nOverloadMaxUnits
            columns1.Append(new Column() { Min = 17, Max = 17, Width = 22D, CustomWidth = true }); //nUserEmplID
            columns1.Append(new Column() { Min = 18, Max = 18, Width = 24D, CustomWidth = true }); //nSolicitorEmplID
        }
        ...
        private void GenerateWorksheetContentTitles(SheetData MySheetData, MergeCells MyMergeCells)
        {
            ...
            MyRow2.Append(new Cell { CellReference = "A2", CellValue = new CellValue("Reporte de Usuarios"), DataType = CellValues.String, StyleIndex = 6 });
            ...
            MyRow.Append(new Cell { CellReference = sCOL_USER_ID + nROW_TITLE, CellValue = new CellValue("ID Usuario"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow.Append(new Cell { CellReference = sCOL_USER_LOGIN + nROW_TITLE, CellValue = new CellValue("Login de Usuario"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow.Append(new Cell { CellReference = sCOL_USER_NAME + nROW_TITLE, CellValue = new CellValue("Nombre"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow.Append(new Cell { CellReference = sCOL_USER_SURNAME + nROW_TITLE, CellValue = new CellValue("Apellido"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow.Append(new Cell { CellReference = sCOL_USER_EMAIL + nROW_TITLE, CellValue = new CellValue("EMail"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow.Append(new Cell { CellReference = sCOL_USER_DELETE_DATE + nROW_TITLE, CellValue = new CellValue("Fecha Baja"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow.Append(new Cell { CellReference = sCOL_REQUESTS_FOR_OTHERS + nROW_TITLE, CellValue = new CellValue("Solicita para otros usuarios"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow.Append(new Cell { CellReference = sCOL_USER_EMPL_ID + nROW_TITLE, CellValue = new CellValue("EmplID de Usuario"), DataType = CellValues.String, StyleIndex = 4 });
            MySheetData.Append(MyRow);
        }
        private void GenerateWorksheetContent(SheetData MySheetData, List<UsersResult> MyList)
        {
            int nRow = 5;
            foreach (var x in MyList)
            {
                Row MyRow = new Row { RowIndex = (UInt32)nRow };
                MyRow.Append(new Cell { CellReference = sCOL_USER_ID + nRow, CellValue = new CellValue(x.nUserID.ToString()), DataType = CellValues.String, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = sCOL_USER_LOGIN + nRow, CellValue = new CellValue(x.sUserLogin), DataType = CellValues.String, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = sCOL_USER_NAME + nRow, CellValue = new CellValue(x.sUserName), DataType = CellValues.String, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = sCOL_USER_SURNAME + nRow, CellValue = new CellValue(x.sUserSurname), DataType = CellValues.String, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = sCOL_USER_EMAIL + nRow, CellValue = new CellValue(x.sUserEMail), DataType = CellValues.String, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = sCOL_USER_DELETE_DATE + nRow, CellValue = new CellValue((x.dtUserDeleteDate == null ? "" : ((DateTime)x.dtUserDeleteDate).ToShortDateString())), DataType = CellValues.String, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = sCOL_REQUESTS_FOR_OTHERS + nRow, CellValue = new CellValue((x.nRequestsForOtherUsers == 1 ? "SI" : "NO")), DataType = CellValues.String, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = sCOL_USER_EMPL_ID + nRow, CellValue = new CellValue(Convert.ToString(x.nUserEmplID)), DataType = CellValues.String, StyleIndex = 5 });
                MySheetData.Append(MyRow);
                nRow = nRow + 1;
            }
        }
