...
{//luis - 2012-06-18
    ...
    public class SolicitudeProductDetail
    {
        const string sCOL_RECEPTION_DATE = "A";
        const string sCOL_REQUEST_CODE = "B";
        const string sCOL_STATUS = "C";
        const string sCOL_SOLICITOR_SURNAME = "D";
        const string sCOL_SOLICITOR_NAME = "E";
        const string sCOL_SOLICITOR_FILE = "F";
        const string sCOL_PRODUCT_CODE = "G";
        const string sCOL_PRODUCT_DESCRIPTION = "H";
        const string sCOL_PRODUCT_AMMOUNT = "I";
        const string sCOL_ORIGINAL_AMMOUNT = "J";
        const string sCOL_OBSERVATIONS = "K";
        const string sCOL_REJECTION_DATE = "L";
        const string sCOL_DELIVERY_DATE = "M";
        //Neha- 20- oct-2013
        const string sCOL_SOLICITUDE_TYPE = "N";
        const string sCOL_EXPIRATION_DATE = "O";
        const string sCOL_RECEIPT_INITIAL_DATE = "P";
        const string sCOL_RECEIPT_FINAL_DATE = "Q";

        
        private string sCOL_FINAL = "Q";
        ...
        public string Report()
        {
            ...
            {
                var List = db.SolicitudeProductDetail(nSUserID, nProductID, dtBegin, dtEnd,
                         Convert.ToInt32(HttpContext.Current.Session["UserID"].ToString())).ToList();
                string sFile = DateTime.Now.ToString("yyMMddHHmmss") + DateTime.Now.Millisecond + "_SolicitudeProductDetail.xlsx";
        ...
        private void CreatePackage(String filePath, List<SolicitudeProductDetailResult> List)
        {
        ...
        public void CreateParts(SpreadsheetDocument excel, List<SolicitudeProductDetailResult> MyList)
        {
        ...
        {
            columns1.Append(new Column() { Min = 1, Max = 1, Width = 19D, CustomWidth = true }); //ReceptionDate
            columns1.Append(new Column() { Min = 2, Max = 2, Width = 19D, CustomWidth = true }); //RequestCode
            columns1.Append(new Column() { Min = 3, Max = 3, Width = 25D, CustomWidth = true }); //Status
            
            columns1.Append(new Column() { Min = 4, Max = 4, Width = 28D, CustomWidth = true }); //SolicitorSurname
            columns1.Append(new Column() { Min = 5, Max = 5, Width = 25D, CustomWidth = true }); //SolicitorName
            columns1.Append(new Column() { Min = 6, Max = 6, Width = 12D, CustomWidth = true }); //SolicitorFile
            
            columns1.Append(new Column() { Min = 7, Max = 7, Width = 23D, CustomWidth = true }); //ProductCode
            columns1.Append(new Column() { Min = 8, Max = 8, Width = 45D, CustomWidth = true }); //ProductDescription
            columns1.Append(new Column() { Min = 9, Max = 9, Width = 20D, CustomWidth = true }); //ProductAmmount
            
            columns1.Append(new Column() { Min = 10, Max = 10, Width = 21D, CustomWidth = true }); //OriginalAmmount
            
            columns1.Append(new Column() { Min = 11, Max = 11, Width = 31D, CustomWidth = true }); //Observations
            
            columns1.Append(new Column() { Min = 12, Max = 12, Width = 18D, CustomWidth = true }); //RejectionDate
            columns1.Append(new Column() { Min = 13, Max = 13, Width = 18D, CustomWidth = true }); //DeliveryDate
            //Neha- 21-oct-2013
            columns1.Append(new Column() { Min = 14, Max = 14, Width = 18D, CustomWidth = true });
            columns1.Append(new Column() { Min = 15, Max = 15, Width = 18D, CustomWidth = true });
            columns1.Append(new Column() { Min = 16, Max = 16, Width = 18D, CustomWidth = true });
            columns1.Append(new Column() { Min = 17, Max = 17, Width = 18D, CustomWidth = true });
        ...
        private void GenerateWorksheetContentTitles(SheetData MySheetData, MergeCells MyMergeCells)
        {
            ...
            MyRow2.Append(new Cell { CellReference = "A2", CellValue = new CellValue("Reporte de detalle de productos por pedido"), DataType = CellValues.String, StyleIndex = 6 });
            ...
            MyRow.Append(new Cell { CellReference = sCOL_RECEPTION_DATE + nROW_TITLE, CellValue = new CellValue("Fecha Recepción"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow.Append(new Cell { CellReference = sCOL_REQUEST_CODE + nROW_TITLE, CellValue = new CellValue("Código de Solicitud"), DataType = CellValues.String, StyleIndex = 4 });
            ...
            MyRow.Append(new Cell { CellReference = sCOL_SOLICITOR_FILE + nROW_TITLE, CellValue = new CellValue("Legajo"), DataType = CellValues.String, StyleIndex = 4 });
            
            MyRow.Append(new Cell { CellReference = sCOL_PRODUCT_CODE + nROW_TITLE, CellValue = new CellValue("Código de Producto"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow.Append(new Cell { CellReference = sCOL_PRODUCT_DESCRIPTION + nROW_TITLE, CellValue = new CellValue("Descripción"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow.Append(new Cell { CellReference = sCOL_PRODUCT_AMMOUNT + nROW_TITLE, CellValue = new CellValue("Cantidad Pedida"), DataType = CellValues.String, StyleIndex = 4 });
            
            MyRow.Append(new Cell { CellReference = sCOL_ORIGINAL_AMMOUNT + nROW_TITLE, CellValue = new CellValue("Cantidad Original"), DataType = CellValues.String, StyleIndex = 4 });
            ...
            //Author:Neha Upadhyay 21-oct-2013
            //Added to show solicitude type
        ...
        private void GenerateWorksheetContent(SheetData MySheetData, List<SolicitudeProductDetailResult> MyList)
        {
            int nRow = 5;
            foreach (var x in MyList)
            {
                Row MyRow = new Row { RowIndex = (UInt32)nRow };
                MyRow.Append(new Cell { CellReference = sCOL_RECEPTION_DATE + nRow, CellValue = new CellValue(x.dtReceptionDate.ToShortDateString()), DataType = CellValues.String, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = sCOL_REQUEST_CODE + nRow, CellValue = new CellValue(x.nRequestCode.ToString()), DataType = CellValues.String, StyleIndex = 5 });
                ...
                MyRow.Append(new Cell { CellReference = sCOL_SOLICITOR_FILE + nRow, CellValue = new CellValue(x.sSolicitorFile), DataType = CellValues.String, StyleIndex = 5 });
                
                MyRow.Append(new Cell { CellReference = sCOL_PRODUCT_CODE + nRow, CellValue = new CellValue(x.sProductCode), DataType = CellValues.String, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = sCOL_PRODUCT_DESCRIPTION + nRow, CellValue = new CellValue(x.sProductDescription), DataType = CellValues.String, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = sCOL_PRODUCT_AMMOUNT + nRow, CellValue = new CellValue(x.nProductAmmount.ToString()), DataType = CellValues.String, StyleIndex = 5 });
                
                MyRow.Append(new Cell { CellReference = sCOL_ORIGINAL_AMMOUNT + nRow, CellValue = new CellValue(x.nOriginalAmmount.ToString()), DataType = CellValues.String, StyleIndex = 5 });
