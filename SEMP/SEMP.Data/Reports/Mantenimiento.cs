...
{//luis - 2012-06-18
    ...
    public class Mantnimiento
    {
        ...
        const string sCOL_BILLED_AMMOUNT = "C";
        ...
        public string Report()
        {
            ...
            {
                //var List = db.Requests(nSUserID, dtBegin, dtEnd,
        ...
        {
            columns1.Append(new Column() { Min = 1, Max = 1, Width = 19D, CustomWidth = true });
        ...
        private void GenerateWorksheetContentTitles(SheetData MySheetData, MergeCells MyMergeCells)
        {
            ...
            MyRow2.Append(new Cell { CellReference = "A2", CellValue = new CellValue("Mantnimiento"), DataType = CellValues.String, StyleIndex = 6 });
            ...
            MyRow.Append(new Cell { CellReference = sCOL_BILLED_AMMOUNT + nROW_TITLE, CellValue = new CellValue("Cantidad Facturada"), DataType = CellValues.String, StyleIndex = 4 });
        ...
        private void GenerateWorksheetContent(SheetData MySheetData, List<Requests_MoneyAccumulatedResult> MyList)
        {
            ...
            foreach (var x in MyList)
            {
                ...
                MyRow.Append(new Cell { CellReference = sCOL_BILLED_AMMOUNT + nRow, CellValue = new CellValue(x.nBilledAmount.ToString()), DataType = CellValues.String, StyleIndex = 5 });
