...
{//luis - 2012-06-18
    ...
    public class Requests
    {
        ...
        //Added to display expiration date
        const string sCOL_EXPIRATION_DATE = "M";
        //Added to show receipt initial date
        const string sCOL_RECEIPT_INITIAL_DATE = "N";
        //Added to show receipt final date
        const string sCOL_RECEIPT_FINAL_DATE = "O";

        private string sCOL_FINAL = "O";
        ...
        public string Report()
        {
            using (var db = new BridgeDataContext())
            {
                ...
                string sFile = DateTime.Now.ToString("yyMMddHHmmss") + DateTime.Now.Millisecond + "_Requests.xlsx";
        ...
        private void CreatePackage(String filePath, List<RequestsResult> List)
        {
        ...
        public void CreateParts(SpreadsheetDocument excel, List<RequestsResult> MyList)
        {
        ...
        private void GenerateWorksheetContentTitles(SheetData MySheetData, MergeCells MyMergeCells)
        {
            ...
            MyRow2.Append(new Cell { CellReference = "A2", CellValue = new CellValue("Reporte de Solicitudes"), DataType = CellValues.String, StyleIndex = 6 });
        ...
        private void GenerateWorksheetContent(SheetData MySheetData, List<RequestsResult> MyList)
        {
            int nRow = 5;
