...
namespace SEMP.Data
{//luis - 2012-06-14
    public class EstimateForSolitude
    {
        const string _sCOL_PRODUCT_ORIGIN = "A";
        const string _sCOL_PRODUCT_DESCRIPTION = "B";
        const string _sCOL_LAST_MONTHS_AMMOUNT = "C";
        const string _sCOL_MONTHLY_AVERAGE = "D";
        const string _sCOL_CURRENT_STOCK = "E";
        const string _sCOL_COMMITTED_STOCK = "F";
        const string _sCOL_MINIMUM_STOCK = "G";
        const string _sCOL_REQUESTED_AMMOUNT = "H";
        const string _sCOL_AVIABLE_STOCK = "I";
        private string _sCOL_FINAL = "I";
        ...
        public string Report()
        {
            ...
            {
                var List = db.EstimateForSolitudeSelect(Convert.ToInt32(HttpContext.Current.Session["UserID"].ToString())).ToList();
                string sFile = DateTime.Now.ToString("yyMMddHHmmss") + DateTime.Now.Millisecond + "_EstimateForSolitude.xlsx";
        ...
        private void CreatePackage(String filePath, List<EstimateForSolitudeResult> List)
        {
        ...
        public void CreateParts(SpreadsheetDocument excel, List<EstimateForSolitudeResult> MyList)
        {
        ...
        private void GenerateWorksheetContentTitles(SheetData MySheetData, MergeCells MyMergeCells)
        {
            ...
            MyRow2.Append(new Cell { CellReference = "A2", CellValue = new CellValue("Estimado para Pedidos"), DataType = CellValues.String, StyleIndex = 6 });
            ...
            MyRow3.Append(new Cell { CellReference = _sCOL_PRODUCT_ORIGIN + _nROW_TITLE, CellValue = new CellValue("Producto"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow3.Append(new Cell { CellReference = _sCOL_PRODUCT_DESCRIPTION + _nROW_TITLE, CellValue = new CellValue("Producto"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow3.Append(new Cell { CellReference = _sCOL_LAST_MONTHS_AMMOUNT + _nROW_TITLE, CellValue = new CellValue("UltimoMeses"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow3.Append(new Cell { CellReference = _sCOL_MONTHLY_AVERAGE + _nROW_TITLE, CellValue = new CellValue("PromedioMensual"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow3.Append(new Cell { CellReference = _sCOL_CURRENT_STOCK + _nROW_TITLE, CellValue = new CellValue("StockActual"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow3.Append(new Cell { CellReference = _sCOL_COMMITTED_STOCK + _nROW_TITLE, CellValue = new CellValue("StockComprometido"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow3.Append(new Cell { CellReference = _sCOL_MINIMUM_STOCK + _nROW_TITLE, CellValue = new CellValue("StockMinimo"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow3.Append(new Cell { CellReference = _sCOL_REQUESTED_AMMOUNT + _nROW_TITLE, CellValue = new CellValue("StockDisponible"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow3.Append(new Cell { CellReference = _sCOL_AVIABLE_STOCK + _nROW_TITLE, CellValue = new CellValue("CantidadPedida"), DataType = CellValues.String, StyleIndex = 4 });

            MySheetData.Append(MyRow3);

        }
        private void GenerateWorksheetContent(SheetData MySheetData, List<EstimateForSolitudeResult> MyList)
        {
            int nRow = _nROW_TITLE + 1;
            foreach (var x in MyList)
            {
                Row MyRow = new Row { RowIndex = (UInt32)nRow };
                MyRow.Append(new Cell { CellReference = _sCOL_PRODUCT_ORIGIN + nRow, CellValue = new CellValue(x.sProductOrigin), DataType = CellValues.String, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = _sCOL_PRODUCT_DESCRIPTION + nRow, CellValue = new CellValue(x.sProductDescription), DataType = CellValues.String, StyleIndex = 5 });

                MyRow.Append(new Cell { CellReference = _sCOL_LAST_MONTHS_AMMOUNT + nRow, CellValue = new CellValue(x.nLastMonthsAmmount.ToString()), DataType = CellValues.Number, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = _sCOL_MONTHLY_AVERAGE + nRow, CellValue = new CellValue(x.nMonthlyAverage.ToString()), DataType = CellValues.Number, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = _sCOL_CURRENT_STOCK + nRow, CellValue = new CellValue(x.nCurrentStock.ToString()), DataType = CellValues.Number, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = _sCOL_COMMITTED_STOCK + nRow, CellValue = new CellValue(x.nCommittedStock.ToString()), DataType = CellValues.Number, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = _sCOL_MINIMUM_STOCK + nRow, CellValue = new CellValue(x.nMinimumStock.ToString()), DataType = CellValues.Number, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = _sCOL_REQUESTED_AMMOUNT + nRow, CellValue = new CellValue(x.nRequestedAmmount.ToString()), DataType = CellValues.Number, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = _sCOL_AVIABLE_STOCK + nRow, CellValue = new CellValue(x.nAviableStock.ToString()), DataType = CellValues.Number, StyleIndex = 5 });
