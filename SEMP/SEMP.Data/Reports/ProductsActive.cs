    ...
    public class ProductsActive
    {
        ...
        public string Report()
        {
            using (var db = new BridgeDataContext())
            {
                ...
                string sFile = DateTime.Now.ToString("yyMMddHHmmss") + DateTime.Now.Millisecond + "_ProductActive.xlsx";
        ...
        private void GenerateWorksheetContentTitles(SheetData MySheetData, MergeCells MyMergeCells)
        {
            ...
            MyRow2.Append(new Cell { CellReference = "A2", CellValue = new CellValue("Productos disponibles"), DataType = CellValues.String, StyleIndex = 6 });
