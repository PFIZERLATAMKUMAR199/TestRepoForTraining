...
namespace SEMP.Data
{//luis - 2012-06-15
    public class SalesAdministrationReport
    {
        const string _sCOL_BEGIN = "A";
        const string _sCOL_EMP_ID = "B";
        const string _sCOL_USUARIO = "C";
        const string _sCOL_RELATIVE_NAME = "D";
        const string _sCOL_PRODUCT = "E";
        const string _sCOL_PRODUCT_NAME = "F";
        const string _sCOL_AMOUNT = "G";

        private string _sCOL_FINAL = "G";
        ...
        {//luis - 2012-06-18
            ...
            {
                var List = db.ReportSalesAdministration(dtBegin, dtEnd, nSUserID,
                    Convert.ToInt32(HttpContext.Current.Session["UserID"].ToString())).ToList();
                string sFile = DateTime.Now.ToString("yyMMddHHmmss") + DateTime.Now.Millisecond + "_SalesAdministrationReport.xlsx";
        ...
        private void CreatePackage(String filePath, List<ReportSalesAdministrationResult> List)
        {
        ...
        public void CreateParts(SpreadsheetDocument excel, List<ReportSalesAdministrationResult> MyList)
        {
        ...
        private void GenerateWorkbookStylesColumnWidth(Columns columns1)
        {
            ...
            columns1.Append(new Column() { Min = 2, Max = 2, Width = 10D, CustomWidth = true });
            columns1.Append(new Column() { Min = 3, Max = 3, Width = 40D, CustomWidth = true });
            columns1.Append(new Column() { Min = 4, Max = 4, Width = 40D, CustomWidth = true });
            columns1.Append(new Column() { Min = 5, Max = 5, Width = 10D, CustomWidth = true });
            columns1.Append(new Column() { Min = 6, Max = 6, Width = 40D, CustomWidth = true });
        ...
        private void GenerateWorksheetContentTitles(SheetData MySheetData, MergeCells MyMergeCells)
        {
            ...
            MyRow2.Append(new Cell { CellReference = "A2", CellValue = new CellValue("Informe para Administración de Ventas"), DataType = CellValues.String, StyleIndex = 6 });
            ...
            MyRow3.Append(new Cell { CellReference = _sCOL_BEGIN + _nROW_TITLE, CellValue = new CellValue("Fecha"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow3.Append(new Cell { CellReference = _sCOL_EMP_ID + _nROW_TITLE, CellValue = new CellValue("Empleado"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow3.Append(new Cell { CellReference = _sCOL_USUARIO + _nROW_TITLE, CellValue = new CellValue("Empleado"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow3.Append(new Cell { CellReference = _sCOL_RELATIVE_NAME + _nROW_TITLE, CellValue = new CellValue("Familiar"), DataType = CellValues.String, StyleIndex = 4 });
            ...
            MyRow3.Append(new Cell { CellReference = _sCOL_AMOUNT + _nROW_TITLE, CellValue = new CellValue("Cantidad"), DataType = CellValues.String, StyleIndex = 4 });

            MySheetData.Append(MyRow3);
        }
        private void GenerateWorksheetContent(SheetData MySheetData, List<ReportSalesAdministrationResult> MyList)
        {
            int nRow = _nROW_TITLE + 1;
            foreach (var x in MyList)
            {
                Row MyRow = new Row { RowIndex = (UInt32)nRow };
                MyRow.Append(new Cell { CellReference = _sCOL_BEGIN + nRow, CellValue = new CellValue(x.dtBegin.ToString()), DataType = CellValues.String, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = _sCOL_EMP_ID + nRow, CellValue = new CellValue(x.sEmpID), DataType = CellValues.String, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = _sCOL_USUARIO + nRow, CellValue = new CellValue(x.sUsuarioName), DataType = CellValues.String, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = _sCOL_RELATIVE_NAME + nRow, CellValue = new CellValue(x.sRelativeName), DataType = CellValues.String, StyleIndex = 5 });
                ...
                MyRow.Append(new Cell { CellReference = _sCOL_AMOUNT + nRow, CellValue = new CellValue(x.nAmount.ToString()), DataType = CellValues.Number, StyleIndex = 5 });
