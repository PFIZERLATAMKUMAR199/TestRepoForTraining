...
{//luis - 2012-06-18
    ...
    {
        //const string sCOL_REQUEST_CODE = "A";
        //const string sCOL_STATUS = "B";
        //const string sCOL_CREATION_USER = "C";
        //const string sCOL_APPROVAL_USER = "D";
        //const string sCOL_APPROVAL_DATE = "E";
        //const string sCOL_REJECTION_DATE = "F";
        //const string sCOL_DELIVERY_DATE = "G";
        //const string sCOL_SOLICITOR_NAME = "H";
        //const string sCOL_SOLICITOR_SURNAME = "I";
        //const string sCOL_OBSERVATIONS = "J";
        //const string sCOL_LOCATION = "K";
        //const string sCOL_SOLICITUDE_TYPE = "L";
    
        //const string sCOL_EXPIRATION_DATE = "M";
    
        //const string sCOL_RECEIPT_INITIAL_DATE = "N";
  
        //const string sCOL_RECEIPT_FINAL_DATE = "O";
        //const string sCOL_MONEY_ACCUMULATED_PER_APPLICATION = "P";
        ////const string sCOL_MONEY_ACCUMULATED = "Q";

        //private string sCOL_FINAL = "P";
        const string sCOL_SOLICITOR_SURNAME="A";
        const string sCOL_SOLICITOR_NAME = "B";
        const string sCOL_BILLED_AMOUNT = "C";
        private string sCOL_FINAL = "C";
        const int nROW_TITLE = 4;
        ...
        public string   Report()
        {
            ...
            {
                var List = db.Requests_MoneyAccumulated(dtBegin, dtEnd,
                    Convert.ToInt32(HttpContext.Current.Session["UserID"].ToString())).ToList();
                string sFile = DateTime.Now.ToString("yyMMddHHmmss") + DateTime.Now.Millisecond + "_RequestsMoneyAccumulated.xlsx";
        ...
        private void CreatePackage(String filePath, List<Requests_MoneyAccumulatedResult> List)
        {
        ...
        public void CreateParts(SpreadsheetDocument excel, List<Requests_MoneyAccumulatedResult> MyList)
        {
            ...
            MyWorksheet.Append(new AutoFilter() { Reference = "A" + nROW_TITLE + ":" + sCOL_FINAL + nROW_TITLE });
        ...
        {
            columns1.Append(new Column() { Min = 1, Max = 1, Width = 25D, CustomWidth = true });
            columns1.Append(new Column() { Min = 2, Max = 2, Width = 25D, CustomWidth = true });
            columns1.Append(new Column() { Min = 3, Max = 3, Width = 25D, CustomWidth = true });

            //columns1.Append(new Column() { Min = 1, Max = 1, Width = 19D, CustomWidth = true }); //RequestCode
            //columns1.Append(new Column() { Min = 2, Max = 2, Width = 25D, CustomWidth = true }); //Status
            //columns1.Append(new Column() { Min = 3, Max = 3, Width = 25D, CustomWidth = true }); //CreationUser
            //columns1.Append(new Column() { Min = 4, Max = 4, Width = 21D, CustomWidth = true }); //ApprovalUser

            //columns1.Append(new Column() { Min = 5, Max = 5, Width = 21D, CustomWidth = true }); //ApprovalDate
            //columns1.Append(new Column() { Min = 6, Max = 6, Width = 18D, CustomWidth = true }); //RejectionDate
            //columns1.Append(new Column() { Min = 7, Max = 7, Width = 18D, CustomWidth = true }); //DeliveryDate

            //columns1.Append(new Column() { Min = 8, Max = 8, Width = 25D, CustomWidth = true }); //SolicitorName
            //columns1.Append(new Column() { Min = 9, Max = 9, Width = 28D, CustomWidth = true }); //SolicitorSurname

            //columns1.Append(new Column() { Min = 10, Max = 10, Width = 31D, CustomWidth = true }); //Observations

            //columns1.Append(new Column() { Min = 11, Max = 11, Width = 25D, CustomWidth = true }); //Location

            //columns1.Append(new Column() { Min = 12, Max = 12, Width = 25D, CustomWidth = true }); //SolicitudeType
          
            //columns1.Append(new Column() { Min = 13, Max = 13, Width = 21D, CustomWidth = true }); //ExpirationDate
           
            //columns1.Append(new Column() { Min = 14, Max = 14, Width = 21D, CustomWidth = true }); //ReceiptInitialDate
          
            //columns1.Append(new Column() { Min = 15, Max = 15, Width = 21D, CustomWidth = true }); //ReceiptFinalDate
            //columns1.Append(new Column() { Min = 16, Max = 16, Width = 21D, CustomWidth = true });
            //columns1.Append(new Column() { Min = 17, Max = 17, Width = 21D, CustomWidth = true });
        }
        private static void CreateWorkbookPartContent(WorkbookPart MyWorkbookPart)
        {
            ...
            MySheets.Append(new Sheet { Name = "Report", SheetId = 1, Id = "rId1" });
        ...
        {
            Row MyRow1 = new Row { };
            MyRow1.Append(new Cell { CellReference = "A1", CellValue = new CellValue("Productos para el Personal"), DataType = CellValues.String, StyleIndex = 1 });
            MyRow1.Append(new Cell { CellReference = sCOL_FINAL + "1", CellValue = new CellValue("Fecha : " + DateTime.Now.ToShortDateString()), DataType = CellValues.String, StyleIndex = 2 });
            ...
            MyRow2.Append(new Cell { CellReference = "A2", CellValue = new CellValue("Mantenimiento"), DataType = CellValues.String, StyleIndex = 6 });
            MySheetData.Append(MyRow2);

            MergeCell mergeCell1 = new MergeCell() { Reference = "A2:" + sCOL_FINAL + "2" };
            MyMergeCells.Append(mergeCell1);

            Row MyRow = new Row { RowIndex = (UInt32)nROW_TITLE };

            MyRow.Append(new Cell { CellReference = sCOL_SOLICITOR_SURNAME + nROW_TITLE, CellValue = new CellValue("Apellido"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow.Append(new Cell { CellReference = sCOL_SOLICITOR_NAME + nROW_TITLE, CellValue = new CellValue("Nombre"), DataType = CellValues.String, StyleIndex = 4 });
            MyRow.Append(new Cell { CellReference = sCOL_BILLED_AMOUNT + nROW_TITLE, CellValue = new CellValue("Cantidad Facturada"), DataType = CellValues.String, StyleIndex = 4 });
            //MyRow.Append(new Cell { CellReference = sCOL_REQUEST_CODE + nROW_TITLE, CellValue = new CellValue("Codigo de Solicitud"), DataType = CellValues.String, StyleIndex = 4 });
            //MyRow.Append(new Cell { CellReference = sCOL_STATUS + nROW_TITLE, CellValue = new CellValue("Estado"), DataType = CellValues.String, StyleIndex = 4 });
            //MyRow.Append(new Cell { CellReference = sCOL_CREATION_USER + nROW_TITLE, CellValue = new CellValue("Usuario Alta"), DataType = CellValues.String, StyleIndex = 4 });
            //MyRow.Append(new Cell { CellReference = sCOL_APPROVAL_USER + nROW_TITLE, CellValue = new CellValue("Usuario Aprobación"), DataType = CellValues.String, StyleIndex = 4 });

            //MyRow.Append(new Cell { CellReference = sCOL_APPROVAL_DATE + nROW_TITLE, CellValue = new CellValue("Fecha Aprobación"), DataType = CellValues.String, StyleIndex = 4 });
            //MyRow.Append(new Cell { CellReference = sCOL_REJECTION_DATE + nROW_TITLE, CellValue = new CellValue("Fecha Rechazo"), DataType = CellValues.String, StyleIndex = 4 });
            //MyRow.Append(new Cell { CellReference = sCOL_DELIVERY_DATE + nROW_TITLE, CellValue = new CellValue("Fecha Entrega"), DataType = CellValues.String, StyleIndex = 4 });

            //MyRow.Append(new Cell { CellReference = sCOL_SOLICITOR_NAME + nROW_TITLE, CellValue = new CellValue("Nombre"), DataType = CellValues.String, StyleIndex = 4 });
            //MyRow.Append(new Cell { CellReference = sCOL_SOLICITOR_SURNAME + nROW_TITLE, CellValue = new CellValue("Apellido"), DataType = CellValues.String, StyleIndex = 4 });

            //MyRow.Append(new Cell { CellReference = sCOL_OBSERVATIONS + nROW_TITLE, CellValue = new CellValue("Observaciones"), DataType = CellValues.String, StyleIndex = 4 });

            //MyRow.Append(new Cell { CellReference = sCOL_LOCATION + nROW_TITLE, CellValue = new CellValue("Locación"), DataType = CellValues.String, StyleIndex = 4 });
            //MyRow.Append(new Cell { CellReference = sCOL_SOLICITUDE_TYPE + nROW_TITLE, CellValue = new CellValue("Tratamiento"), DataType = CellValues.String, StyleIndex = 4 });

            //MyRow.Append(new Cell { CellReference = sCOL_EXPIRATION_DATE + nROW_TITLE, CellValue = new CellValue("Fecha Expiracion"), DataType = CellValues.String, StyleIndex = 4 });
   
            //MyRow.Append(new Cell { CellReference = sCOL_RECEIPT_INITIAL_DATE + nROW_TITLE, CellValue = new CellValue("Receta Inicio Fecha "), DataType = CellValues.String, StyleIndex = 4 });
  
            //MyRow.Append(new Cell { CellReference = sCOL_RECEIPT_FINAL_DATE + nROW_TITLE, CellValue = new CellValue("Receta Fin Fecha"), DataType = CellValues.String, StyleIndex = 4 });
            //MyRow.Append(new Cell { CellReference = sCOL_MONEY_ACCUMULATED_PER_APPLICATION + nROW_TITLE, CellValue = new CellValue("El dinero acumulado por solicitude"), DataType = CellValues.String, StyleIndex = 4 });
            ////MyRow.Append(new Cell { CellReference = sCOL_MONEY_ACCUMULATED + nROW_TITLE, CellValue = new CellValue("Total de dinero acumulado"), DataType = CellValues.String, StyleIndex = 4 });

            MySheetData.Append(MyRow);
        }
        private void GenerateWorksheetContent(SheetData MySheetData, List<Requests_MoneyAccumulatedResult> MyList)
        {
            int nRow = 5;
            foreach (var x in MyList)
            {
                ...
                MyRow.Append(new Cell { CellReference = sCOL_SOLICITOR_SURNAME + nRow, CellValue = new CellValue(x.sSolicitorSurname), DataType = CellValues.String, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = sCOL_SOLICITOR_NAME + nRow, CellValue = new CellValue(x.sSolicitorName), DataType = CellValues.String, StyleIndex = 5 });
                MyRow.Append(new Cell { CellReference = sCOL_BILLED_AMOUNT + nRow, CellValue = new CellValue(x.nBilledAmount.ToString()), DataType = CellValues.String, StyleIndex = 5 });
                MySheetData.Append(MyRow);
                nRow = nRow + 1;
            }
                //int nRow = 5;
            ...
            //decimal? TotalMoneyAccumilated=0;
            //foreach (var x in MyList)
            //{
            //    MyRow = new Row { RowIndex = (UInt32)nRow };

            //    MyRow.Append(new Cell { CellReference = sCOL_REQUEST_CODE + nRow, CellValue = new CellValue(Convert.ToString(x.nRequestCode)), DataType = CellValues.String, StyleIndex = 5 });
            //    MyRow.Append(new Cell { CellReference = sCOL_STATUS + nRow, CellValue = new CellValue(x.sStatus), DataType = CellValues.String, StyleIndex = 5 });
            //    MyRow.Append(new Cell { CellReference = sCOL_CREATION_USER + nRow, CellValue = new CellValue(x.sCreationUser), DataType = CellValues.String, StyleIndex = 5 });
            //    MyRow.Append(new Cell { CellReference = sCOL_APPROVAL_USER + nRow, CellValue = new CellValue(x.sApprovalUser), DataType = CellValues.String, StyleIndex = 5 });

            //    MyRow.Append(new Cell { CellReference = sCOL_APPROVAL_DATE + nRow, CellValue = new CellValue((x.dtApprovalDate == null ? "" : ((DateTime)x.dtApprovalDate).ToShortDateString())), DataType = CellValues.String, StyleIndex = 5 });
            //    MyRow.Append(new Cell { CellReference = sCOL_REJECTION_DATE + nRow, CellValue = new CellValue((x.dtRejectionDate == null ? "" : ((DateTime)x.dtRejectionDate).ToShortDateString())), DataType = CellValues.String, StyleIndex = 5 });
            //    MyRow.Append(new Cell { CellReference = sCOL_DELIVERY_DATE + nRow, CellValue = new CellValue((x.dtDeliveryDate == null ? "" : ((DateTime)x.dtDeliveryDate).ToShortDateString())), DataType = CellValues.String, StyleIndex = 5 });

            //    MyRow.Append(new Cell { CellReference = sCOL_SOLICITOR_NAME + nRow, CellValue = new CellValue(x.sSolicitorName), DataType = CellValues.String, StyleIndex = 5 });
            //    MyRow.Append(new Cell { CellReference = sCOL_SOLICITOR_SURNAME + nRow, CellValue = new CellValue(x.sSolicitorSurname), DataType = CellValues.String, StyleIndex = 5 });

            //    MyRow.Append(new Cell { CellReference = sCOL_OBSERVATIONS + nRow, CellValue = new CellValue(x.sObservations), DataType = CellValues.String, StyleIndex = 5 });

            //    MyRow.Append(new Cell { CellReference = sCOL_LOCATION + nRow, CellValue = new CellValue(x.sLocation), DataType = CellValues.String, StyleIndex = 5 });

            //    MyRow.Append(new Cell { CellReference = sCOL_SOLICITUDE_TYPE + nRow, CellValue = new CellValue(((x.sSolicitudeType) == null ? "" : x.sSolicitudeType)), DataType = CellValues.String, StyleIndex = 5 });
             
            //    MyRow.Append(new Cell { CellReference = sCOL_EXPIRATION_DATE + nRow, CellValue = new CellValue((x.dtExpiration == null ? "" : ((DateTime)x.dtExpiration).ToShortDateString())), DataType = CellValues.String, StyleIndex = 5 });
           
            //    MyRow.Append(new Cell { CellReference = sCOL_RECEIPT_INITIAL_DATE + nRow, CellValue = new CellValue((x.dtReceiptInitialDate == null ? "" : ((DateTime)x.dtReceiptInitialDate).ToShortDateString())), DataType = CellValues.String, StyleIndex = 5 });
        
            //    MyRow.Append(new Cell { CellReference = sCOL_RECEIPT_FINAL_DATE + nRow, CellValue = new CellValue((x.dtReceiptFinalDate == null ? "" : ((DateTime)x.dtReceiptFinalDate).ToShortDateString())), DataType = CellValues.String, StyleIndex = 5 });
            //    MyRow.Append(new Cell { CellReference = sCOL_MONEY_ACCUMULATED_PER_APPLICATION + nRow, CellValue = new CellValue(x.nMoneyAccumulatedPerApplication.ToString()), DataType = CellValues.String, StyleIndex = 5 });
            //    //MyRow.Append(new Cell { CellReference = sCOL_MONEY_ACCUMULATED + nRow, CellValue = new CellValue(x.nMoneyAccumulated.ToString()), DataType = CellValues.String, StyleIndex = 5 });
            //    TotalMoneyAccumilated = x.nMoneyAccumulated;
            ...
            //MyRow = new Row { RowIndex = (UInt32)nRow };
            //MyRow.Append(new Cell { CellReference = sCOL_RECEIPT_FINAL_DATE + nRow, CellValue = new CellValue("Total de Dinero Acumulado"), DataType = CellValues.String, StyleIndex = 5 });
            //MyRow.Append(new Cell { CellReference = sCOL_MONEY_ACCUMULATED_PER_APPLICATION + nRow, CellValue = new CellValue(TotalMoneyAccumilated.ToString()), DataType = CellValues.String, StyleIndex = 5 });
            //MySheetData.Append(MyRow);
        }
